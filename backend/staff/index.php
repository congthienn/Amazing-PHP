...
<body>
                ...
                <div class="item_content">
                    <div class="item_header">
                        ...
                        <div class="item_navbar">
                            <a href="/../Amazing-PHP/backend/">Trang chủ</a> / <a href="/../Amazing-PHP/backend/staff/">Quản lí nhân viên</a>
                        </div>
                    </div>
                    <div class="staff_list">
                        <div class="staff_list--header">
                            <a href="/../Amazing-PHP/backend/staff/add/" class="btn btn-primary">Thêm nhân viên</a>
                        </div>
    ...
    <script src="/../Amazing-PHP/backend/staff/delete_staff.js"></script>
    <script>
