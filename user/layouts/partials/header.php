    ...
    <div class="grid wide">
        ...
        <div class="header_center">
            ...
            <div class="like">
                ...
                <div class="cart">
                    <a href="/../Amazing-PHP/user/cart/"><i class="fas fa-shopping-cart icon-header"></i></a>
...
<div class="list_category">
    <div class="grid wide">
        <div class="list_content">
            <ul>
                <li><a href="/../Amazing-PHP/user/" class="list_item">Home</a></li>
                <?php
                ...
                <?php foreach($data_category as $val_category):?>
                    <li><a class="list_item" href="/../Amazing-PHP/user/producer/?producer=<?=$val_category['tlh']?>"><?=$val_category['tlh']?></a></li>
                <?php endforeach;?>
...
<div class="register_user">
        ...
        <div class="login_content register_content">
            ...
            <div class="login_content--form">
                <form action="/../Amazing-PHP/user/layouts/partials/register_user.php" name="formregisteruser" id="formregisteruser" method="POST">
                    <div class="form--item">
