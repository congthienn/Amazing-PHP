...
<body>
    ...
    <div id="main">
        <div class="container_navbar">
            <div class="grid wide">
                <div class="navbar">
                    <a href="/../Amazing-PHP/user/">Trang chủ</a> <i class="fas fa-angle-right icon_navbar"></i> <a href="/../Amazing-PHP/user/producer/?producer=<?=$result_product['TenLoaiHang']?>"><?=$result_product['TenLoaiHang']?></a> <i class="fas fa-angle-right icon_navbar"></i> <?=$result_product['TenHH']?>
                </div>
            </div>
        </div>
                        ...
                        <div class="related_products_container">
                            ...
                            <div class="container_product_like--item">
                                <?php foreach($data_product_like as $val_product_like):?>
                                    <a href="/../Amazing-PHP/user/product/?product=<?=$val_product_like['mhh']?>">
                        ...
                        <div class="container_same_kind_product">
                            ...
                            <div class="same_kind_product">
                                <?php foreach($data_skp as $val_skp):?>
                                    <a href="/../Amazing-PHP/user/product/?product=<?=$val_skp['mhh']?>">
